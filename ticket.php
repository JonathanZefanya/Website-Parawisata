...
if(isset($_SESSION['username'])){
    ...
    // get the HTML
    ob_start();	
	$comot=mysqli_query($kon,"SELECT * FROM tbl_pesan, tbl_paket, tbl_hotel, tbl_user WHERE tbl_pesan.id_user=tbl_user.id_user AND
        ...
        <tr>
            <td colspan="2" style="width: 100%">
                <div class="zone" style="height: 34mm;position: relative;font-size: 5mm;">
					...
					<span style="position: absolute; left: 32mm; top: 10mm; font-size: 28px; color: red">WISATHAN Tour and Travel</span><br />
                    <span style="position: absolute; left: 32mm; top: 18mm; font-size: 16px;">Ngawi, <?php echo $date; ?></span>
