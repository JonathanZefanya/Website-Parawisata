...
<head>
    ...
    <title>Setup Sejarah Papua</title>
        ...
        <div id="page-wrapper">
            <div class="row col-lg-12">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading"><h3>Setup Sejarah Papua</h3></div>
                    <div class="panel-body">
                        <div class="row col-lg-10">
                        	<form name="setupPapuaSejarah" action="setupSumbarSejarah.php" method="post" enctype="multipart/form-data">
							<?php
                    ...
                    <div class="panel-body">
                        <div class="row col-lg-10">
                        	<table class="table table-hover table-striped">
                                ...
                                <?php
									$no=1;
									$comot=mysqli_query($kon,"select * from setup_sumbar where kat_sumbar='sejarah' order by id_sumbar");
