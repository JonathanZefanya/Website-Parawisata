...
<head>
    ...
    <title>Setup Profil Papua</title>
        ...
        <div id="page-wrapper">
            <div class="row col-lg-12">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading"><h3>Setup Profil Papua</h3></div>
                    <div class="panel-body">
                        <div class="row col-lg-10">
                        	<form name="setupPapuaProfil" action="setupSumbarProfil.php" method="post" enctype="multipart/form-data">
							<?php
