...
<head>
    ...
    <title>Setup Kuliner Khas Papua</title>
        ...
        <div id="page-wrapper">
            <div class="row col-lg-12">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading"><h3>Setup Kuliner Khas Papua</h3></div>
                    <div class="panel-body">
                        <div class="row col-lg-10">
                        	<form name="setupPapuaKuliner" action="setupSumbarKuliner.php" method="post" enctype="multipart/form-data">
							<?php
                            $ngisi = array("", "", "", "");
								if (isset($_GET['id']))
								{
