...
if(isset($_SESSION['user_admin'])){
	...
	{
		mysqli_query($kon,"UPDATE setup_Jatim SET kat_Jatim='kuliner', judul_Jatim='$judul', konten_Jatim='$_POST[konten]' WHERE id_Jatim= '$_POST[id]'");
...
<head>
    ...
    <title>Setup Kuliner Khas Jatim</title>
        ...
        <div id="page-wrapper">
            <div class="row col-lg-12">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading"><h3>Setup Kuliner Khas Jatim</h3></div>
                    <div class="panel-body">
                        <div class="row col-lg-10">
                        	<form name="setupJatimKuliner" action="setupJatimKuliner.php" method="post" enctype="multipart/form-data">
							<?php
								if (isset($_GET['id']))
								{
                    ...
                    <div class="panel-body">
                        <div class="row col-lg-10">
                        	<table class="table table-hover table-striped">
                                ...
                                <?php
									$no=1;
									$comot=mysqli_query($kon,"select * from setup_Jatim where kat_Jatim='kuliner' order by id_Jatim");
								...
								?>
                                    <tr>
                                        ...
                                        <div class="tooltip-demo">
                                            <a href="setupJatimKuliner.php?id=<?php echo $isi_tbl[0]; ?>"><button type="button" class="btn btn-primary btn-xs"data-toggle="tooltip" data-placement="top" title="Edit/Hapus Content Kuliner"><i class="fa fa-wrench"></i></button></a>
                                   		</div>
                                        </td>
                                    </tr>
                                <?php
