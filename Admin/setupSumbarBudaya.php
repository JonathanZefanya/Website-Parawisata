...
<head>
    ...
    <title>Setup Seni dan Budaya Papua</title>
        ...
        <div id="page-wrapper">
            <div class="row col-lg-12">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading"><h3>Setup Seni dan Budaya Papua</h3></div>
                    <div class="panel-body">
                        <div class="row col-lg-10">
                        	<form name="setupPapuaBudaya" action="setupSumbarBudaya.php" method="post" enctype="multipart/form-data">
							<?php
                            $ngisi = array("","","","");
								if (isset($_GET['id']))
								{
