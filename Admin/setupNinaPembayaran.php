...
if(isset($_SESSION['user_admin'])){
	...
	{
		mysqli_query($kon,"UPDATE setup_about SET kat_about='pembayaran', judul_about='$judul', konten_about='$_POST[konten]' WHERE id_about= '$_POST[id]'");
                    ...
                    <div class="panel-body">
                        <div class="row col-lg-10">
                        	<table class="table table-hover table-striped">
                                ...
                                <?php
									$no=1;
                                    $comot=mysqli_query($kon,"select * from setup_about where kat_about='pembayaran' order by id_about");
