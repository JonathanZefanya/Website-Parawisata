...
if(isset($_SESSION['user_admin'])){
	...
	else if(isset($_POST['Edit']))
	{
		...
		mysqli_query($kon,"UPDATE setup_about SET kat_about='profil', judul_about='$judul', konten_about='$_POST[konten]' WHERE id_about= '$_POST[id]'");
	
	}
	
	else if(isset($_POST['Delete']))
	{
		mysqli_query($kon,"DELETE FROM setup_about WHERE id_about = '$_POST[id]'");
...
<head>
    ...
    <title>Setup Profil WISATHAN</title>
        ...
        <div id="page-wrapper">
            <div class="row col-lg-12">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading"><h3>Setup Profil WISATHAN</h3></div>
                    ...
                    <div class="panel-body">
                        <div class="row col-lg-10">
                        	<table class="table table-hover table-striped">
                                ...
                                <?php
									$no=1;
                                    $comot=mysqli_query($kon,"select * from setup_about where kat_about='profil' order by id_about");
